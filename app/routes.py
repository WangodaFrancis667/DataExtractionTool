import os
import uuid
from flask import Blueprint, request, render_template, send_from_directory, current_app, redirect, url_for, flash
...
def upload():
    ...
    # process
    try:
        out_path = process_document(upload_path,
    ...
    flash(f'File processed: {os.path.basename(out_path)}', 'success')
    return redirect(url_for('main.index'))
